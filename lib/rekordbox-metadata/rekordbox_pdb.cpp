...
std::set<rekordbox_pdb_t::page_type_t>
rekordbox_pdb_t::_build_values_page_type_t() {
...
const std::set<rekordbox_pdb_t::page_type_t>
    rekordbox_pdb_t::_values_page_type_t =
        rekordbox_pdb_t::_build_values_page_type_t();
bool rekordbox_pdb_t::_is_defined_page_type_t(rekordbox_pdb_t::page_type_t v) {
  return rekordbox_pdb_t::_values_page_type_t.find(v) !=
         rekordbox_pdb_t::_values_page_type_t.end();
}

rekordbox_pdb_t::rekordbox_pdb_t(kaitai::kstream *p__io,
...
void rekordbox_pdb_t::_read() {
  ...
  if (!(m_gap == std::string("\x00\x00\x00\x00", 4))) {
    throw kaitai::validation_not_equal_error<std::string>(
        std::string("\x00\x00\x00\x00", 4), m_gap, m__io,
        std::string("/seq/6"));
  }
...
rekordbox_pdb_t::~rekordbox_pdb_t() { _clean_up(); }

void rekordbox_pdb_t::_clean_up() {
  if (m_tables) {
    for (std::vector<table_t *>::iterator it = m_tables->begin();
         it != m_tables->end(); ++it) {
      delete *it;
    }
    delete m_tables;
...
rekordbox_pdb_t::album_row_t::album_row_t(kaitai::kstream *p__io,
...
rekordbox_pdb_t::album_row_t::~album_row_t() { _clean_up(); }
...
rekordbox_pdb_t::artist_row_t::artist_row_t(
    kaitai::kstream *p__io, rekordbox_pdb_t::row_ref_t *p__parent,
    rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
  m__root = p__root;
...
rekordbox_pdb_t::artist_row_t::~artist_row_t() { _clean_up(); }
...
rekordbox_pdb_t::device_sql_string_t *rekordbox_pdb_t::artist_row_t::name() {
  ...
  f_name = true;
  std::streampos _pos = m__io->pos();
  m__io->seek(_parent()->row_base() +
              ((subtype() == 100) ? (ofs_name_far()) : (ofs_name_near())));
  m_name = new device_sql_string_t(m__io, this, m__root);
  m__io->seek(_pos);
  return m_name;
}
...
rekordbox_pdb_t::artwork_row_t::~artwork_row_t() { _clean_up(); }
...
rekordbox_pdb_t::color_row_t::color_row_t(kaitai::kstream *p__io,
                                          rekordbox_pdb_t::row_ref_t *p__parent,
                                          rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
...
rekordbox_pdb_t::color_row_t::~color_row_t() { _clean_up(); }
...
rekordbox_pdb_t::device_sql_long_ascii_t::device_sql_long_ascii_t(
    kaitai::kstream *p__io, rekordbox_pdb_t::device_sql_string_t *p__parent,
    rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
  m__root = p__root;
...
void rekordbox_pdb_t::device_sql_long_ascii_t::_read() {
  ...
  m_text =
      kaitai::kstream::bytes_to_str(m__io->read_bytes(length() - 4), "ASCII");
}
...
void rekordbox_pdb_t::device_sql_long_utf16le_t::_read() {
  m_length = m__io->read_u2le();
  m__unnamed1 = m__io->read_u1();
  m_text = kaitai::kstream::bytes_to_str(m__io->read_bytes(length() - 4),
                                         "UTF-16LE");
}
...
rekordbox_pdb_t::device_sql_short_ascii_t::device_sql_short_ascii_t(
    uint8_t p_length_and_kind, kaitai::kstream *p__io,
    rekordbox_pdb_t::device_sql_string_t *p__parent, rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
  m__root = p__root;
...
void rekordbox_pdb_t::device_sql_short_ascii_t::_read() {
  m_text =
      kaitai::kstream::bytes_to_str(m__io->read_bytes(length() - 1), "ASCII");
}
...
rekordbox_pdb_t::device_sql_string_t::device_sql_string_t(
    kaitai::kstream *p__io, kaitai::kstruct *p__parent,
    rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
  m__root = p__root;
...
void rekordbox_pdb_t::device_sql_string_t::_read() {
  ...
  default: {
    m_body =
        new device_sql_short_ascii_t(length_and_kind(), m__io, this, m__root);
    break;
  }
  }
}

rekordbox_pdb_t::device_sql_string_t::~device_sql_string_t() { _clean_up(); }
...
rekordbox_pdb_t::genre_row_t::genre_row_t(kaitai::kstream *p__io,
                                          rekordbox_pdb_t::row_ref_t *p__parent,
                                          rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
...
rekordbox_pdb_t::genre_row_t::~genre_row_t() { _clean_up(); }
...
rekordbox_pdb_t::history_entry_row_t::~history_entry_row_t() { _clean_up(); }
...
rekordbox_pdb_t::key_row_t::key_row_t(kaitai::kstream *p__io,
                                      rekordbox_pdb_t::row_ref_t *p__parent,
                                      rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
...
rekordbox_pdb_t::key_row_t::~key_row_t() { _clean_up(); }
...
rekordbox_pdb_t::label_row_t::label_row_t(kaitai::kstream *p__io,
                                          rekordbox_pdb_t::row_ref_t *p__parent,
                                          rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
...
rekordbox_pdb_t::label_row_t::~label_row_t() { _clean_up(); }
...
rekordbox_pdb_t::page_t::page_t(kaitai::kstream *p__io,
                                rekordbox_pdb_t::page_ref_t *p__parent,
                                rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
  m__root = p__root;
...
rekordbox_pdb_t::page_t::~page_t() { _clean_up(); }
...
void rekordbox_pdb_t::page_t::_clean_up() {
  ...
  if (f_row_groups && !n_row_groups) {
    if (m_row_groups) {
      for (std::vector<row_group_t *>::iterator it = m_row_groups->begin();
           it != m_row_groups->end(); ++it) {
        delete *it;
      }
      delete m_row_groups;
      m_row_groups = 0;
...
std::vector<rekordbox_pdb_t::row_group_t *> *
rekordbox_pdb_t::page_t::row_groups() {
  if (f_row_groups)
    return m_row_groups;
  f_row_groups = true;
  n_row_groups = true;
...
rekordbox_pdb_t::page_ref_t::page_ref_t(kaitai::kstream *p__io,
                                        kaitai::kstruct *p__parent,
                                        rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
...
void rekordbox_pdb_t::page_ref_t::_read() { m_index = m__io->read_u4le(); }

rekordbox_pdb_t::page_ref_t::~page_ref_t() { _clean_up(); }
...
rekordbox_pdb_t::playlist_entry_row_t::~playlist_entry_row_t() { _clean_up(); }
...
rekordbox_pdb_t::playlist_tree_row_t::~playlist_tree_row_t() { _clean_up(); }
...
rekordbox_pdb_t::row_group_t::row_group_t(uint16_t p_group_index,
                                          kaitai::kstream *p__io,
                                          rekordbox_pdb_t::page_t *p__parent,
                                          rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
  m__root = p__root;
...
rekordbox_pdb_t::row_group_t::~row_group_t() { _clean_up(); }
...
void rekordbox_pdb_t::row_group_t::_clean_up() {
  ...
  if (f_rows) {
    if (m_rows) {
      for (std::vector<row_ref_t *>::iterator it = m_rows->begin();
           it != m_rows->end(); ++it) {
        delete *it;
      }
      delete m_rows;
...
std::vector<rekordbox_pdb_t::row_ref_t *> *
rekordbox_pdb_t::row_group_t::rows() {
  if (f_rows)
    return m_rows;
  f_rows = true;
...
rekordbox_pdb_t::row_ref_t::row_ref_t(uint16_t p_row_index,
                                      kaitai::kstream *p__io,
                                      rekordbox_pdb_t::row_group_t *p__parent,
                                      rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
  m__root = p__root;
...
rekordbox_pdb_t::row_ref_t::~row_ref_t() { _clean_up(); }
...
bool rekordbox_pdb_t::row_ref_t::present() {
  ...
  f_present = true;
  m_present =
      (((_parent()->row_present_flags() >> row_index() & 1) != 0) ? (true)
                                                                  : (false));
  return m_present;
}
...
rekordbox_pdb_t::table_t::table_t(kaitai::kstream *p__io,
                                  rekordbox_pdb_t *p__parent,
                                  rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
  m__root = p__root;
...
rekordbox_pdb_t::table_t::~table_t() { _clean_up(); }
...
rekordbox_pdb_t::track_row_t::track_row_t(kaitai::kstream *p__io,
                                          rekordbox_pdb_t::row_ref_t *p__parent,
                                          rekordbox_pdb_t *p__root)
    : kaitai::kstruct(p__io) {
  m__parent = p__parent;
...
rekordbox_pdb_t::track_row_t::~track_row_t() { _clean_up(); }
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::analyze_date() {
  if (f_analyze_date)
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::analyze_path() {
  if (f_analyze_path)
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::autoload_hot_cues() {
  if (f_autoload_hot_cues)
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::date_added() {
  if (f_date_added)
    return m_date_added;
  f_date_added = true;
  std::streampos _pos = m__io->pos();
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::file_path() {
  if (f_file_path)
    return m_file_path;
  f_file_path = true;
  std::streampos _pos = m__io->pos();
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::kuvo_public() {
  if (f_kuvo_public)
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::release_date() {
  if (f_release_date)
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::unknown_string_2() {
  if (f_unknown_string_2)
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::unknown_string_3() {
  if (f_unknown_string_3)
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::unknown_string_4() {
  if (f_unknown_string_4)
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::unknown_string_5() {
  if (f_unknown_string_5)
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::unknown_string_6() {
  if (f_unknown_string_6)
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::unknown_string_7() {
  if (f_unknown_string_7)
...
rekordbox_pdb_t::device_sql_string_t *
rekordbox_pdb_t::track_row_t::unknown_string_8() {
  if (f_unknown_string_8)
