...
for %%f in (src/main.c src/ui/components/theme.c src/ui/components/fonts.c src/ui/components/helpers.c src/ui/views/topbar.c src/ui/views/info.c src/ui/views/splash.c src/ui/views/settings.c src/ui/views/about.c src/ui/views/mixer.c src/ui/player/bottomstrip.c src/ui/player/beatfx.c src/ui/player/deckinfo.c src/ui/player/deckstrip.c src/ui/player/waveform.c src/ui/player/player.c src/audio/engine.c src/audio/scalers.c src/input/keyboard.c src/ui/browser/browser.c src/core/audio_backend.c src/core/logic/quantize.c src/core/logic/sync.c src/core/logic/settings_io.c src/core/logic/control_object.c src/core/midi/midi_handler.c src/core/midi/midi_mapper.c src/core/midi/midi_backend_win.c) do (
...
%CXX% %CXXFLAGS% -c src/engine/engineobject.cpp -o src/engine/engineobject.o || exit /b 1
%CXX% %CXXFLAGS% -c src/audio/engine_bridge.cpp -o src/audio/engine_bridge.o || exit /b 1
%CXX% %CXXFLAGS% -c src/engine/util/sample_util.cpp -o src/engine/util/sample_util.o || exit /b 1
%CXX% %CXXFLAGS% -c src/engine/readaheadmanager.cpp -o src/engine/readaheadmanager.o || exit /b 1
%CXX% %CXXFLAGS% -c src/engine/enginebuffer.cpp -o src/engine/enginebuffer.o || exit /b 1
%CXX% %CXXFLAGS% -c src/engine/scalers/enginebufferscale.cpp -o src/engine/scalers/enginebufferscale.o || exit /b 1
%CXX% %CXXFLAGS% -c src/engine/scalers/enginebufferscalest.cpp -o src/engine/scalers/enginebufferscalest.o || exit /b 1
%CXX% %CXXFLAGS% -c src/engine/scalers/enginebufferscalerubberband.cpp -o src/engine/scalers/enginebufferscalerubberband.o || exit /b 1
...
echo Linking...
%CXX% %CXXFLAGS% src/main.o src/ui/components/theme.o src/ui/components/fonts.o src/ui/components/helpers.o src/ui/views/topbar.o src/ui/views/info.o src/ui/views/splash.o src/ui/views/settings.o src/ui/views/about.o src/ui/views/mixer.o src/ui/player/bottomstrip.o src/ui/player/beatfx.o src/ui/player/deckinfo.o src/ui/player/deckstrip.o src/ui/player/waveform.o src/ui/player/player.o src/audio/engine.o src/audio/scalers.o src/audio/engine_bridge.o src/engine/util/engine_math.o src/engine/util/sample_util.o src/engine/readaheadmanager.o src/engine/enginebuffer.o src/engine/engineobject.o src/engine/scalers/enginebufferscale.o src/engine/scalers/enginebufferscalest.o src/engine/scalers/enginebufferscalerubberband.o src/engine/fx/dsp_utils.o src/engine/fx/colorfx/space.o src/engine/fx/colorfx/dub_echo.o src/engine/fx/colorfx/sweep.o src/engine/fx/colorfx/noise.o src/engine/fx/colorfx/crush.o src/engine/fx/colorfx/filter.o src/engine/fx/colorfx/colorfx_manager.o src/engine/fx/beatfx/delay.o src/engine/fx/beatfx/echo.o src/engine/fx/beatfx/pingpong.o src/engine/fx/beatfx/spiral.o src/engine/fx/beatfx/roll.o src/engine/fx/beatfx/sliproll.o src/engine/fx/beatfx/reverb.o src/engine/fx/beatfx/helix.o src/engine/fx/beatfx/flanger.o src/engine/fx/beatfx/phaser.o src/engine/fx/beatfx/bfilter.o src/engine/fx/beatfx/trans.o src/engine/fx/beatfx/pitch.o src/engine/fx/beatfx/vinylbrake.o src/engine/fx/beatfx/beatfx_manager.o src/input/keyboard.o src/ui/browser/browser.o src/core/audio_backend.o src/core/logic/quantize.o src/core/logic/sync.o src/core/logic/settings_io.o src/core/logic/control_object.o src/core/midi/midi_handler.o src/core/midi/midi_mapper.o src/core/midi/midi_backend_win.o lib/kaitai/kaitai/kaitaistream.o lib/rekordbox-metadata/rekordbox_anlz.o lib/rekordbox-metadata/rekordbox_pdb.o lib/serato/serato_parser.o lib/serato/serato_waveform.o src/library/rekordbox_reader.o src/library/serato_reader.o %LDFLAGS% -o %OUT_DIR%\%TARGET% || exit /b 1
