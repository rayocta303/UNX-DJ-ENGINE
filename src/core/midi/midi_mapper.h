...
typedef enum {
    ...
    SCRIPT_ACTION_BEATFX_LEFT,
    SCRIPT_ACTION_BEATFX_RIGHT,
    SCRIPT_ACTION_PAD_FX,
    SCRIPT_ACTION_QUICK_JUMP,
    SCRIPT_ACTION_WAVEFORM_ZOOM,
    SCRIPT_ACTION_MERGE_FX_SEL,
    SCRIPT_ACTION_SAMPLER_SHIFT
} MidiScriptAction;
