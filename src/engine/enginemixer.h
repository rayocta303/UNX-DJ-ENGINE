...
#include "engine/util/parented_ptr.h"
#include "engine/util/samplebuffer.h"
...
class EngineMixer : public QObject, public AudioSource {
  ...
  private:
    ...
    std::array<unx::SampleBuffer, 3> m_outputBusBuffers;
    unx::SampleBuffer m_booth;
    unx::SampleBuffer m_head;
    unx::SampleBuffer m_talkover;
    unx::SampleBuffer m_talkoverHeadphones;
    unx::SampleBuffer m_sidechainMix;
