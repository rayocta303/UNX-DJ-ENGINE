...
#include "engine/util/optional.h"
...
Q_DECLARE_TYPEINFO(unx::audio::ChannelCount, Q_PRIMITIVE_TYPE);
Q_DECLARE_METATYPE(unx::audio::ChannelCount)

Q_DECLARE_TYPEINFO(unx::audio::ChannelLayout, Q_PRIMITIVE_TYPE);
Q_DECLARE_METATYPE(unx::audio::ChannelLayout)

Q_DECLARE_TYPEINFO(unx::audio::OptionalChannelLayout, Q_MOVABLE_TYPE);
Q_DECLARE_METATYPE(unx::audio::OptionalChannelLayout)

Q_DECLARE_TYPEINFO(unx::audio::SampleRate, Q_PRIMITIVE_TYPE);
Q_DECLARE_METATYPE(unx::audio::SampleRate)

Q_DECLARE_TYPEINFO(unx::audio::Bitrate, Q_PRIMITIVE_TYPE);
Q_DECLARE_METATYPE(unx::audio::Bitrate)
