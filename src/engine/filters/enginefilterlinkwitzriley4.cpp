...
EngineFilterLinkwitzRiley4Low::EngineFilterLinkwitzRiley4Low(
        unx::audio::SampleRate sampleRate, double freqCorner1) {
    setFrequencyCorners(sampleRate, freqCorner1);
}

void EngineFilterLinkwitzRiley4Low::setFrequencyCorners(unx::audio::SampleRate sampleRate,
        double freqCorner1) {
...
void EngineFilterLinkwitzRiley4High::setFrequencyCorners(unx::audio::SampleRate sampleRate,
        double freqCorner1) {
    setCoefs2(sampleRate,
            2,
