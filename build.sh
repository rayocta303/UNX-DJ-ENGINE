...
C_FILES=(
    ...
    src/core/logger.c src/core/memory_guard.c src/core/system_info.c src/core/logic/quantize.c src/core/logic/sync.c src/core/logic/settings_io.c src/core/logic/jog_config.c
